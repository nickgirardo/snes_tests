; Retrieved from https://en.wikibooks.org/wiki/Super_NES_Programming/Initialization_Tutorial/Snes_Init 01-16-2019
...
Init:
    ...
    lda     #$09
    sta 	$2105   ; Mode 0, = Graphic mode register
    stz 	$2106   ; noplanes, no mosaic, = Mosaic register
    ; Background vram locations
    ; bg 1 = 2107, bg 2 = 2108, bg 3 = 2109, bg 4 = 210a
    ; Format: aaaa aabb
    ...
    ; TODO probably change these to storing 0
